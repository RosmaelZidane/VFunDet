...
class BigVulDatasetSBERTDataModule(pl.LightningDataModule):
...
if __name__ == "__main__":
    data_module = BigVulDatasetSBERTDataModule(BigVulDatasetSBERT, batch_size=64)
    model = LitSBERT()
