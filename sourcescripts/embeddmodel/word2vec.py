...
class BigVulDatasetWord2VecDataModule(pl.LightningDataModule):
...
if __name__ == "__main__":
    data_module = BigVulDatasetWord2VecDataModule(BigVulDatasetWord2Vec, batch_size=32)
    model = LitWord2Vec()
