...
from processing.dataprocessing import bigvul
...
class BigVulDatasetNLP:
    def __init__(self, partition="train", random_labels=False):
        ...
        self.att_mask = tokenized["attention_mask"]  # you can add the function level dependency influence here in this case
...
if __name__ == "__main__":
    data_module = BigVulDatasetNLPDataModule(BigVulDatasetNLP, batch_size=32)
    model = LitCodeBERT()
